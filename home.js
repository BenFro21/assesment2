...
//         }else if(el !== zipCode){
//             return console.log('Sorry we cant deliver to that adress')
//         }
//     })
// }
...
let canWeDeliver = (zipCode) => {
    if(deliveryAreaZipCodes.includes(zipCode)){
        ...
        return 'Sorry, we cant deliver to that adress'
    }
}


console.log(canWeDeliver(852056))
